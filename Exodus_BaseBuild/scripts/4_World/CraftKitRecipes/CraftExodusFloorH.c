class CraftExodusFloorHacth extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Floor Hatch Kit";
		...
		//result1
		AddResult("EXD_BB_Kit_Floor_Hatch");//add results here
	...
	{
		if( g_Game.GetExodusConfig().Get_CanCraftConstructionsKits() )
		{
			return true;
		}
		return false;
