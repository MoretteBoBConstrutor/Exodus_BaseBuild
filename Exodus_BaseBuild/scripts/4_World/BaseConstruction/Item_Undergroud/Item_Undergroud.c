...
/* 
// É possivel usar como base o EXD_Base, porem tem que ser criado como uma segunda parte, isso abre oportunidades para fazer mais partes porem precisa ser feitos testes
class Land_UnderGroud_Part extends EXD_Base
{
		override bool IsNormalPart()
    {
        return true;
